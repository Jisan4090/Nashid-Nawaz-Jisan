 ...
 System.out.println("\n\n\n\tPress right key.......");
  ...
  if(pk==1){
	    ...
	    if (choice == 1) {
	      ...
	      System.out.println("\n\t\t\tThe current conversion rate, 1 Rupee = 1.32 BDT\n");
	    ...
	    // For Dollar Conversion
	      ...
	      System.out.println("\n\t\t\tThe current conversion rate, 1 USD = 109.89 BDT\n");
	    ...
	    // For Ringit Conversion
	      ...
	      System.out.println("\n\t\t\tThe current conversion rate, 1 Ringit = 23.46 BDT\n");
	    ...
	    // For Euro Conversion
	      ...
	      System.out.println("\n\t\t\tThe current conversion rate, 1 Euro = 120.23 BDT\n");
	    ...
	    // For Riyal Conversion
	      ...
	      System.out.println("\n\t\t\tThe current conversion rate, 1 Riyal = 29.41 BDT\n");
