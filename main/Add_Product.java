		    ...
		    System.out.print("\n\n\n\t\t\t\t\t |----------------------------------------------------------|\n");
			      ...
			      System.out.print("\t\t\t\t\t |----------------------------------------------------------|\n");
			          ...
			          if(a==1){
			              ...
			              for(int i = 0;i<b ; i++){
			                  System.out.print("Product code: 10"+(i+1)+" Name: ");
			                  String d = s.next();
			            ...
			            System.out.print("Enter the last digit of the product code you want to delete: ");
			            int r = s.nextInt();
			         
			             productinfo.remove(r-1);
			      ...
			      int index=1;
			        for (String x:productinfo ) {
			              System.out.println("Product Code-10"+(index++)+": "+x);
			              }
